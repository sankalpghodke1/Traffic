...
def realTime():
    while True:
        ...
        cv2.putText(img, "Up        ", (40, 195), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
        cv2.line(img, (0, up_line_position), (iw, up_line_position), (28, 44, 253), 2)
        cv2.putText(img, "Down        ", (40, 275), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
